ActiveAdmin.register Application do
  ...
  show do |app|
    ...
    h3 link_to "Review", new_admin_application_review_path(app), :class => 'review_button'
    h3 link_to "Follow-up", flag_app_path(app), :class => 'flag_app' unless app.flagged?
    h3 link_to "Junk", mark_junk_path(app), :class => 'mark_junk' unless app.junk?
    br
